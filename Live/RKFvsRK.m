...
initial = initial(1:use_planets*4);
...
tspan = [0 end_time];
tic
[t,y] = rungeKuttaFehlberg(func,tspan, initial, 1/100*year, 1e-10);
% [t,y] = rungeKutta(func,tspan, initial, 1/100*year);
toc
%Plot orbits 
hold on
